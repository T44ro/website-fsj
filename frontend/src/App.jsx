...
function App() {
  // 1. INI ADALAH "SAKLAR" UNTUK MENENTUKAN HALAMAN MANA YANG AKTIF
  const [activePage, setActivePage] = useState('home');

  // 2. FUNGSI UNTUK MENEKAN SAKLAR SAAT MENU DIKLIK
  const changePage = (pageName, event) => {
    event.preventDefault(); // Mencegah browser reload
    setActivePage(pageName);
    window.scrollTo(0, 0); // Otomatis scroll ke paling atas saat ganti halaman
  };

  return (
    <div className="site-shell">
      {/* ========================================= */}
      {/* MENU NAVIGASI (SELALU MUNCUL DI ATAS)     */}
      {/* ========================================= */}
      ...
      {/* ========================================= */}
      {/* LOGIKA SAKLAR HALAMAN DIMULAI DI SINI     */}
      {/* ========================================= */}
      
      {activePage === 'home' ? (
        
        /* JIKA SAKLAR = HOME, TAMPILKAN KODE ASLI TEMANMU */
        <>
          <main className="homepage" id="home">
            ...
            {/* Kotak About versi pendek buatan temanmu dikembalikan */}
            ...
            <div className="footer-top">
              ...
              <div className="footer-links">
                ...
                <div>
                  ...
                  <a href="#programs">Mini Training</a>
                  <a href="#programs">Community Impact</a>
                </div>
                <div>
                  <h3>Insights</h3>
                  <a href="#blog">News</a>
        ...
        /* JIKA SAKLAR = ABOUT, HANYA TAMPILKAN DESAIN BUATANMU */
        <AboutUs />
